...
*/
  ...
  var instruction_pages = [
    ...
    "<p>Welcome to this experiment. This experiment should take a total of <strong>30 minutes</strong>. </br></br> You will be compensated at a base rate of $15/hour for a total of $3.75, which you will receive as long as you complete the study.</p>",
    ...
    "<p>In this experiment, you will be asked to match an object to a picture of the same object from a different view.\n A picture of an object will appear at the top of the screen. There will be two outlined options underneath - all you need to do is simply click on the outlined object that is the same as the one on top! You will do several practice trials before starting the experiment.' width=512, height=512></p>",
