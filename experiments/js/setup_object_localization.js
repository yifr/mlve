...
*/
  ...
  var instruction_pages = [
    ...
    "<p>Bonuses will be awarded based on two factors. The number of correct responses, and whether the bounding boxes you draw accurately outline the object (make sure you're not just drawing boxes around the dot!).</p>",
    ...
    "<p>Ready? Once you continue there will be six practice trials, and then the experiment will begin.</p><p>Once you click to continue, you won't be able to review any of the instructions.</p><p>To review any of the instructions now, just hit the back arrow to return to a previous page.</p>",
  ];
