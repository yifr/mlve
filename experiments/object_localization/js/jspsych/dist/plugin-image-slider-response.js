var jsPsychImageSliderResponse = (function (jspsych) {
  ...
  const info = {
    ...
    parameters: {
      ...
      /**
       * If true, the image will be drawn onto a img element (prevents blank screen between consecutive images in some browsers).
       * If false, the image will be shown via an img element.
       */
      render_on_canvas: {
        type: jspsych.ParameterType.BOOL,
        pretty_name: "Render on img",
        default: true,
      },
    },
  };
  ...
  class ImageSliderResponsePlugin {
    ...
    trial(display_element, trial) {
      ...
      if (trial.render_on_canvas) {
        ...
        // add img and slider to content wrapper div
        content_wrapper.insertBefore(img, content_wrapper.firstElementChild);
        content_wrapper.insertBefore(slider_container, img.nextElementSibling);
        // add content wrapper div to screen and draw image on img
        ...
        document
          .getElementById("jspsych-image-slider-response-response")
